...
Route::get('/', function () {
    ...
    $abouts = DB::table('home_abouts')->first();//61
    $services = DB::table('services')->get();
    $images = Multipic::all(); //62
...
Route::get('/contact-seo-friendly',[ContactController::class,'index'])->name('con');
...
// Service all route
Route::get('/home/service',[ServiceController::class,'Service'])->name('home.service');
